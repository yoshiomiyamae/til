...
## FAT領域
FAT12の場合は1クラスタあたり12bits、FAT16の場合は1クラスタあたり16bits、FAT32の場合は1クラスタあたり32bits使用する。
### FAT12 / FAT16の場合
FAT領域はBPB_BytsPerSec * BPB_RsvdSecCntから始まり、BPB_FATSz16 * BPB_NumFATs * BPB_BytsPerSec分存在する。
